...
export interface CommentsAdapter {
     ...
     *
     * The object which is passed as a parameter can contain following properties:
     * * channelId: string | symbol;
     * * threadId: string;
     ...
     * The resolved data object should contain following properties:
     * * threadId: string;
     ...
     *
     * Keep in mind that for security reasons, `authorId`, `createdAt`, `resolvedBy` and `resolvedAt` properties
     * are not passed in `updateCommentThread()` call and you should not set them as a result of this call.
     *
